...
class Caser(nn.Module):
    ...
    def __init__(self, num_users, num_items, L=5, dims=50, nv=4, nh=16, drop=0.5, ac_conv='relu', ac_fc='relu'):
        ...
        # vertical conv layer
        self.conv_v = nn.Conv2d(1, self.n_v, (self.L, 1))
        ...
        self.fc1_dim_v = self.n_v * self.dims
        self.fc1_dim_h = self.n_h * len(lengths)
        fc1_dim_in = self.fc1_dim_v + self.fc1_dim_h
        # W1, b1 can be encoded with nn.Linear
        self.fc1 = nn.Linear(fc1_dim_in, self.dims)
